        ...
        BaseService.HttpGet("graph/selectDashbordCount").then(
            (response) => {
               ...
               // console.log(JSON.stringify(response.data['UserCount'][0]));
                ...
                setShipCount(response.data['ShipCount'][0]);
        ...
        <div className="grid">
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    ...
                    <span className="text-500">for this month of {userCount.curr_month}</span>
                </div>
            </div>
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    ...
                    <span className="text-500">for this month of {transCount.curr_month}</span>
                </div>
            </div>
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    ...
                    <span className="text-500">for this month of {installCount.curr_month}</span>
                </div>
            </div>
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    ...
                    <span className="text-500">for this month of {shipCount.curr_month}</span>
                </div>
            </div>
